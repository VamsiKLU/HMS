...
import { X, Calendar, Clock, User, Zap, MessageSquare, Video, Star, ChevronRight } from 'lucide-react';
                  ...
                  >
                    <div className="flex flex-col items-center text-center">
                      ...
                      <div className="flex items-center mb-2">
                        ...
                        <span className="text-sm text-gray-500 dark:text-gray-500 ml-2">• {doctor.experience}</span>
                      </div>
                      <p className="text-xs text-gray-600 dark:text-gray-400 line-clamp-2">{doctor.bio}</p>
                    </div>
                  </div>
                ))}
              </div>
