  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <button className="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 border border-gray-200 dark:border-gray-700 rounded-lg p-6 text-left transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg shadow-sm">
          <FileText className="h-8 w-8 text-green-600 mb-4 transition-transform duration-300 ease-in-out group-hover:scale-110" />
          <h3 className="font-semibold text-lg mb-2 text-gray-900 dark:text-white">View Records</h3>
        ...
        <button className="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 border border-gray-200 dark:border-gray-700 rounded-lg p-6 text-left transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg shadow-sm">
          ...
          <h3 className="font-semibold text-lg mb-2 text-gray-900 dark:text-white">Chat with Doctor</h3>
          <p className="text-sm text-gray-500 dark:text-gray-400">Send a message</p>
        </button>

        <button className="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 border border-gray-200 dark:border-gray-700 rounded-lg p-6 text-left transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg shadow-sm">
          <Download className="h-8 w-8 text-orange-600 mb-4 transition-transform duration-300 ease-in-out group-hover:scale-110" />
          <h3 className="font-semibold text-lg mb-2 text-gray-900 dark:text-white">Download Reports</h3>
          <p className="text-sm text-gray-500 dark:text-gray-400">Get PDF reports</p>
        </button>
      </div>
